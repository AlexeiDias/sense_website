...
const EssentialFeatures = () => {
  return (
    <div className="essential-features align-items-center" id='features'>
      <Row  className="g-4">    
  ...
  ></iframe>
    <div className="card-body">
      <h4 className="text-center titleColor">Dollhouse</h4>
  ...
  <iframe 
    ...
    <div className="card-body">
    <h4 className="text-center titleColor">Highlight Reels</h4>
  ...
  <iframe 
    ...
    <div className="card-body">
      <h4 className="text-center titleColor">360 Photos</h4>
  ...
  <iframe 
    ...
    <div className="card-body">
      <h4 className="text-center titleColor">QR Code</h4>
...
Then copy and paste the QR code onto your flyers and other materials. Your intended audience can scan the QR code with their smartphone and explore the Matterport Space with their phone.</p>
  ...
  <iframe 
    ...
    <div className="card-body">
    <h4 className="text-center titleColor">Google Street View</h4>
  ...
  <iframe 
    ...
    <div className="card-body">
      <h4 className="text-center titleColor">Mattertags</h4>
