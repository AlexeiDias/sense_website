...
const BusinessComponent = () => {
  return (
    <Container className="my-5">
      <h2 className="text-center mb-4 title"> Here's a concise explanation of the benefits:</h2>
      ...
      <Row>
        ...
        <h1><i class="bi bi-piggy-bank-fill title"></i></h1>
          ...
          <p> They are a cost-effective marketing tool, eliminating the need for multiple in-person showings and open houses, while maximizing the property's exposure.</p>
        </Col>
      </Row>
    </Container>
  );
